...
*/
  ...
  useFrame(() => {
    ...
    */
    ...
    //console.log("morphtargetDictionary",nodes.left_eye.children[0].morphTargetDictionary)
    //console.log("morphtargetInfluences",nodes.left_eye.children[0].morphTargetInfluences)
...
useGLTF.preload("/models/talkywalkyneu.glb");
